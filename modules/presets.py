...
CHUANHU_TITLE = i18n("一人团队专用deepseek 🚀")

CHUANHU_DESCRIPTION = i18n("让你一个人也能做电影")
...
MODEL_METADATA = {
    ...
    "Claude 3.5 Sonnet": {
        ...
        "description": "claude35_sonnet_description",
        "token_limit": 200000,
        "max_generation": 4096,
        "multimodal": True,
        "placeholder": {
    ...
    "DeepSeek-Chat": {
        ...
        "placeholder": {
            "logo": "file=web_assets/model_logos/deepseek.png",
            "slogan": i18n("gpt_default_slogan"),
        }
    },
    "DeepSeek-Reasoner": {
